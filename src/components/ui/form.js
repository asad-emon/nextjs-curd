            ...
            <div className="mx-auto w-full max-w-sm sm:max-w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form className="flex flex-col justify-center space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="md:columns-2">
                        ...
                        {children}
                    <button type="submit" className="mx-auto sm:w-2/3 lg:w-1/2 w-full text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit application</button>
                </form>
            </div>
        </>
    );
