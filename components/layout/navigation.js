...
export function Navigation() {
    ...
    return (
        <>
            <nav>
                <ul className="flex justify-center sm:justify-end items-center font-bold mt-0 space-x-8 rtl:space-x-reverse text-sm">
                    ...
                    <li className={`text-gray-900 dark:text-white hover:text-blue-500 ${pathname == '/create' && 'text-indigo-600'}`}>
                        <button onClick={() => signIn('github')} type="button" className="py-2 px-4 max-w-md flex justify-center items-center bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 focus:ring-offset-gray-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
